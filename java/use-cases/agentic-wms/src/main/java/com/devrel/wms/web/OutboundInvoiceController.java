...
public class OutboundInvoiceController {
	...
	@PutMapping("/{number}")
	public ResponseEntity<OutboundInvoice> update(
			@PathVariable String number,
			@RequestBody OutboundInvoice outboundInvoice) {
		return ResponseEntity.ok(outboundInvoiceService.update(number, outboundInvoice));
	}
