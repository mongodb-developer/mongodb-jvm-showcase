...
- [`Spring Data Unlocked: Getting Started With Java and MongoDB`](https://dev.to/ricardohsmello/spring-data-unlocked-getting-started-with-java-and-mongodb-49f6)

- [`Spring Data Unlocked: Advanced Queries With MongoDB`](https://dev.to/ricardohsmello/spring-data-unlocked-advanced-queries-with-mongodb-4jef)

- [`Spring Data Unlocked: Performance Optimization Techniques With MongoDB`](https://dev.to/ricardohsmello/spring-data-unlocked-performance-optimization-techniques-with-mongodb-5f5)
